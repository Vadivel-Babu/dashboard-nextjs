...
const Navbar = () => {
  return (
    <header className="flex flex-row xl:flex-col gap-6 py-8 px-10 items-center justify-between ">
      <div className="flex lg:flex-row xl:flex-col gap-11 items-center">
        <Link href="/">
          <svg
            width="35"
            height="35"
        ...
        <nav className="hidden md:flex flex-row xl:flex-col gap-4 items-center">
          <Link
            href="/"
            className="bg-[#2C3A58] p-3 rounded-2xl transition-all hover:bg-[#252c3c]"
          >
            <svg
              width="22"
              height="21"
          ...
          <Link href="" className=" p-3 rounded-2xl hover:bg-[#252c3c]">
            <svg
              width="20"
              height="23"
              viewBox="0 0 20 23"
