...
const Navbar = () => {
  ...
  return (
    <header className="flex flex-row xl:flex-col gap-6 py-8 px-10 items-center justify-between ">
      <div className="flex lg:flex-row xl:flex-col justify-center gap-11 items-center">
        <Link href="/">
          <Image
            src={image ? image : "/Frame.png"}
            alt="logo"
            width={23}
            height={23}
          />
        </Link>
        <nav className=" flex flex-row xl:flex-col gap-4 items-center">
          <Link
            href="/"
            className={` ${
              path === "/" ? "bg-[#2C3A58] " : ""
            }p-1 md:p-3 rounded-2xl transition-all hover:bg-[#252c3c]`}
          >
            <svg
              width="22"
              height="21"
          ...
          <Link
            href=""
            className="hidden p-3 rounded-2xl transition-all hover:bg-[#252c3c]"
          >
            <svg
              width="22"
              height="23"
      ...
      <div className="flex flex-row xl:flex-col gap-4 items-center">
        <div className="w-[44px] h-[44px] rounded-full flex items-baseline justify-center overflow-hidden bg-blue-300">
          <Image
            src="/person1.png"
            className="relative bottom-[-9px]"
            alt="person"
            width={30}
            height={30}
          />
        ...
        <Link
          href="/"
          className="p-3 rounded-2xl transition-all hover:bg-[#252c3c]"
        >
          <svg
            width="22"
            height="20"
